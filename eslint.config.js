...
export default [
  ...
  {
    files: ['functions/index.js', 'functions/tourScoring.js', 'functions/pcsMapping.js', 'functions/tourTeams.js', 'functions/tourSync.js', 'functions/invites.js', 'functions/leagueRecap.js', 'functions/stageTip.js', 'functions/startlistSync.js', 'functions/salesPitch.js', 'functions/liveTicker.js', 'functions/liveMap.js', 'functions/riderTags.js', 'functions/riderTagCanon.js', 'functions/stageTimes.js', 'functions/leagueBonus.js', 'functions/tourSummary.js', 'functions/thankYouEmail.js', 'functions-platform/index.js', 'functions-platform/gameScoring.js', 'functions-platform/startGate.js', 'functions-platform/ligaPoint.js', 'functions-platform/pointOpdeling.js', 'functions-platform/superligaScoring.js', 'functions-platform/superligaSync.js', 'functions-platform/syncProviders.js', 'functions-platform/seedFootball.js', 'functions-platform/driftlog.js', 'functions-platform/paamindelsesGate.js', 'functions-platform/gameLeagues.js', 'functions-platform/mailer.js', 'functions-platform/reminders.js', 'functions-platform/gameRecap.js', 'functions-platform/leagueQuestionRecap.js', 'functions-platform/leagueQuestionScoring.js', 'functions-platform/rensTekst.js', 'functions-platform/inviteTemplate.js', 'functions-platform/playerLeagues.js', 'functions-platform/mailMarkdown.js', 'functions-platform/broadcastImage.js', 'functions-platform/chanceVagt.js', 'functions-platform/livescoreHold.js', 'functions-platform/kampDetaljer.js', 'functions-platform/liveMaal.js', 'functions-platform/forladSpil.js', 'functions-platform/adminDeleteUser.js'],
    languageOptions: {
      ecmaVersion: 'latest',
      sourceType: 'commonjs',
      globals: { ...globals.node },
