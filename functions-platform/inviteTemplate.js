...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;">
  ...
  ${card({
    ...
    rows: [
      featureRow({ n: 1, title: 'Combi-bonus &#127920;', text: 'Tip alle kampe p&aring; rundens kupon: oddsene p&aring; dem, du rammer, ganges sammen, og du f&aring;r 2 &times; kvadratroden af produktet i bonus &mdash; h&oslash;jst 25 point. Hver ramt kamp t&aelig;ller fra to rigtige og opefter, og en glemt kamp koster dig ikke bonussen.' }),
