      ...
      <Section emoji="🏆" title="Stilling & tabel">
        ...
        <ul style={{ margin: '0.5rem 0', paddingLeft: '1.2rem' }}>
          <li style={{ marginBottom: '0.4rem' }}>
            ...
            {' '}<strong>Pilen</strong> ved din placering måler den <strong>samme runde</strong>: den
            viser, om du er rykket op eller ned, siden runden begyndte. Står der ingen pil, har du
            holdt din plads — også selv om du har hentet mange point, for det kan alle andre have
            gjort.
          </li>
          <li style={{ marginBottom: '0.4rem' }}>
