...
// Guiden får SPILLET, så den kun beskriver de faner, spillet har. Uden gaten
    ...
    <div>
      ...
      <Section emoji="🗓️" title="Sådan forløber en runde">
        <ul style={{ margin: 0, paddingLeft: '1.2rem' }}>
          ...
          <li style={{ marginBottom: '0.4rem' }}>
            ...
            det rigtige 1X2 markeres, og dine point afregnes i samme øjeblik. Alt kommer fra ligaens
          ...
          <li style={{ marginBottom: '0.4rem' }}>
            <strong>Løbende:</strong> {game?.pulje
              ? <>Afgiv dit <Tab fane="pulje">🎖️ Pulje</Tab>-tip før deadline (én gang), dyst i</>
              : <>Dyst i</>}
      ...
      <Section emoji="🏆" title="Stilling & tabel">
        ...
        <ul style={{ margin: '0.5rem 0', paddingLeft: '1.2rem' }}>
          <li style={{ marginBottom: '0.4rem' }}>
            ...
            afgøres, så føringen i runden kan skifte, indtil den sidste kamp er spillet. En
            {' '}<strong>👑</strong> sidder hos den, der har flest indtil videre — står to lige, bærer de
            den begge. Har hele feltet tabt runden, er der ingen krone. En <strong>–</strong> betyder,
            at du ikke har point i runden endnu.
          </li>
          <li style={{ marginBottom: '0.4rem' }}>
            ...
            og alligevel ligge midt i feltet. Bemærk forskellen på kronen i listen: den er
            <strong> foreløbig</strong> og flytter sig, mens runden spilles. Pokalen her tælles først,
            når runden er helt færdig.
          </li>
          <li style={{ marginBottom: '0.4rem' }}>
      ...
      <Section emoji="👥" title="Mini-ligaer">
        ...
        <p style={{ margin: '0.5rem 0 0' }}>
          ...
          Når et liga-spørgsmål får facit, poster den også <strong>afsløringen</strong>: hvem svarede hvad,
          hvem ramte — og hvem der aldrig fik svaret.
        </p>
      </Section>
