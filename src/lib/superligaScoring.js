 ...
 */
export function puljeScore(picks, facitSaet, { antal = PULJE.POOL_SIZE, perTeam = PULJE.PER_TEAM, perfectBonus = PULJE.PERFECT_BONUS } = {}) {
...
export function bundTeams(matches, n) {
 ...
 */
export function puljeKonfig(game) {
