...
|---|---|---|---|
| Superligaen | `src/lib/superligaScoring.js` | `functions-platform/superligaScoring.js` | 1X2-point = kampens frosne odds; combi-runde-bonus (2·√produkt af ramte odds, loft 25, kuponen er rundens kampe i samme uge); Chancen (indsats × odds−1, loft 8 og 15 % af saldo); pulje-tip (6 hold × 4 point + 10 i bonus); Elo-lite driver oddsene |
